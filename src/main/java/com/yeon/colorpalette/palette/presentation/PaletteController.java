...
public class PaletteController {
	...
	@GetMapping
	public ApiResponse<PaletteReadSliceResponse> readPalette(Pageable pageable,
			@RequestParam(required = false) String color, @RequestParam(required = false) Long tag) {
		return ApiResponse.ok(ResponseMessage.PALETTE_READ_SUCCESS.getMessage(), paletteService.read(pageable, color, tag));
	}
