...
public class AuthController {
	...
	public ApiResponse<AccessTokenResponse> loginByOAuth(@PathVariable String provider, @RequestParam String code) {
		return ApiResponse.ok(ResponseMessage.LOGIN_SUCCESS.getMessage(), authService.loginByOAuth(provider, code));
	}
